  ...
  Widget account() {
    return Padding(
            ...
            child: Row(
              ...
              children: [
              Text("Do you have an account ? ", style: TextStyle(color: Colors.grey, fontSize: 14)),
              SizedBox(width: 5),
              GestureDetector(
                onTap: widget.show,
                child: 
  ...
  Padding SignUP_bottom() {
    return Padding(
            ...
            child: GestureDetector(
              onTap: (){
                AuthentificationRemote().register(email.text, password.text, passwordConfirm.text);
              },
            child: Container(
              ...
              child: Text('Sign Up', style: TextStyle(color: Colors.white, fontSize: 23, fontWeight: FontWeight.bold)),
              ),
    ),
          );
  }
